...
from jimgw.waveform import RipplePPEIMRPhenomD
...
prior = Uniform(
    xmin = [10, 0.125, -1, -1, 0., -0.05, 0., -1, 0., 0.,-1., -1. ],
    xmax = [80., 1., 1, 1, 2000., 0.05, 2*jnp.pi, 1., jnp.pi, 2*jnp.pi, 1., 1.],
    naming = ["M_c", "q", "s1_z", "s2_z",  "d_L", "t_c", "phase_c", "cos_iota", "psi", "ra", "sin_dec", "ppe"],
...
likelihood = TransientLikelihoodFD([H1, L1], waveform=RipplePPEIMRPhenomD(ppe_index=4), trigger_time=gps, duration=4, post_trigger_duration=2)
